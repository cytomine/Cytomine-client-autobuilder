...
import be.cytomine.client.RoiAnnotation;
import be.cytomine.client.Server;
import org.json.simple.JSONObject;


/**
 * An region of interest on a picture
 * 
 ...
 * 
 */
public abstract class AbstractRoiAnnotation
    extends AbstractDomain
{
    ...
    public static RoiAnnotation get(Server server, Long id)
        throws Exception
    {
