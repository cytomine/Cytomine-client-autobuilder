...
import be.cytomine.client.NestedImageInstance;
import be.cytomine.client.Server;
import org.json.simple.JSONObject;


/**
 * An sub image from an image instance (sub area, same image transformed,...)
 * 
 ...
 * 
 */
public abstract class AbstractNestedImageInstance
    extends AbstractDomain
{
    ...
    /**
     * The image source for this sub-image
     * 
     */
    protected Long parent;
    /**
     * Top x position of this image on the sub-image
     * 
     */
    protected Integer x;
    /**
     * Top y position of this image on the sub-image
     * 
     */
    protected Integer y;
    ...
    public void build(Long baseImage, Long project, Long user, Long parent)
        throws Exception
    {
    ...
    public static NestedImageInstance get(Server server, Long id)
        throws Exception
    {
    ...
    public static NestedImageInstance listByImageInstance(Server server, Long idImage, Integer max, Integer offset)
        throws Exception
    {
