...
import be.cytomine.client.JobTemplate;
    ...
    extends AbstractDomain
{
    ...
    public void build(Long project, Long software, String name)
        throws Exception
    {
    ...
    public static JobTemplate get(Server server, Long id)
        throws Exception
    {
    ...
    public static JobTemplate list(Server server, Long project, Long software, Integer max, Integer offset)
        throws Exception
    {
