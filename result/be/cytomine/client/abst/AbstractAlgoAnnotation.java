...
import be.cytomine.client.AlgoAnnotation;
 ...
 * 
 */
public abstract class AbstractAlgoAnnotation
    extends AbstractDomain
{
    ...
    /**
     * The user job that add this annotation
     * 
     */
    protected Long user;
    /**
    ...
    public static AlgoAnnotation get(Server server, Long id)
        throws Exception
    {
    ...
    public static AnnotationListing list(Server server, Integer max, Integer offset)
        throws Exception
    {
